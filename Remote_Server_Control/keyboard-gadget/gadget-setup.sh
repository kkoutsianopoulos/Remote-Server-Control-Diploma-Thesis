...
cat /home/debian/keyboard-gadget/kybd-descriptor.bin > functions/hid.usb0/report_desc                  #  write the binary blob of the report descriptor to report_desc; see HID class spec
